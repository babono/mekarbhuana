...
const coverCaption =
  'mt-3 text-center font-label text-xs leading-relaxed tracking-[0.1em] text-dust uppercase'
      ...
      <section className="relative overflow-hidden bg-bark-700 px-[26px] py-20">
        ...
        <div className="mx-auto grid max-w-shell grid-cols-[repeat(auto-fit,minmax(300px,1fr))] items-center gap-14">
          <div>
            ...
            <p className="m-0 mb-[30px] max-w-[520px] font-body text-[clamp(16px,1.5vw,19px)] leading-[1.75] font-normal text-pretty text-sand">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-[22px]">
              {ebooks.map((book) => (
                <article key={book.id} className="card p-[38px]">
                  ...
                  <p className="m-0 mb-5 font-body text-[15px] leading-[1.8] font-normal text-muted">
                    {book.summary}
                  </p>
                  <div className="flex flex-wrap items-center gap-[18px] font-label text-[11px] leading-relaxed tracking-[0.14em] text-smoke uppercase">
