    ...
    <main>
      <section className="relative overflow-hidden bg-bark-500 px-[26px] pt-[78px] pb-[66px]">
        <div className="mx-auto max-w-shell">
          ...
          <div className="mt-[26px] flex flex-wrap items-center gap-[18px] font-label text-[11px] leading-relaxed tracking-[0.14em] text-smoke uppercase">
      ...
      <section className="bg-cream py-20">
        <div className="mx-auto max-w-shell px-[26px]">
          ...
          <div
            className="max-w-[720px] font-body text-[18px] leading-[1.85] font-normal text-body
          ...
          >
            <p className="font-body text-[21px] leading-[1.75] font-normal text-muted">
              {article.excerpt}
            </p>
        ...
        {locked && (
          <div className="relative -mt-40 bg-linear-to-b from-transparent to-cream to-[130px] pt-40">
            <div className="mx-auto max-w-[640px] bg-bark-450 px-[38px] py-[46px] text-center">
              ...
              <p className="m-0 mb-7 font-body text-[15.5px] leading-[1.8] font-normal text-clay">
        ...
        <div className="mx-auto mt-11 max-w-shell px-[26px]">
          <Link
            href="/read"
            className="font-label text-[11px] leading-none font-medium tracking-[0.16em] text-crimson uppercase"
          >
            ← All field notes
          </Link>
        </div>
